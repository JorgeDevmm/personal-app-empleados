...
<div class="card">
  <div class="px-4 card-header d-flex flex-column flex-md-row justify-content-between align-items-center">
        <a name="" id="" class="btn btn-success my-md-2 px-3 py-2 border-0 rounded-5 " href="?controlador=perfiles&accion=crear" role="button">Agregar Perfiles</a>
          ...
          <tr>
            ...
            <td>
              ...
              <div class="d-flex justify-content-center" role="group" aria-label="">
                ...
                <a href="?controlador=perfiles&accion=editar&id=<?php echo $valor->getId(); ?>" class="d-flex align-items-center btn btn-success  px-3 py-2 border-0 rounded-5 me-2 mb-md-0"><i class="bi bi-pencil-square"></i> Editar</a>
                <a href="?controlador=perfiles&accion=borrar&id=<?php echo $valor->getId(); ?>" class="d-flex align-items-center btn btn-danger  px-3 py-2 border-0 rounded-5 mb-md-0" onclick="return confirm('¿Deseas eliminar?')" ><i class="bi bi-trash"></i> Eliminar</a>
              </div>
            </td>
          </tr>
    <?php }?>     
